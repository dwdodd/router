...
const editUser = (el) => {
    if(localeStorageItem('edit-user')){
        el = localeStorageInfo('edit-user');
    }else{ el = '' }
    ...
    ${buttonSearchInput('add-user', '+ Nuevo usuario', false)}
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 bg-white p-4 rounded shadow-md">
        <div class="mt-1">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" id="names" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Nombres" value="${el.names?el.names:''}"/>
            </div>
        ...
        <div class="mt-1">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" id="surnames" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Apellidos" value="${el.surnames?el.surnames:''}"/>
            </div>
        ...
        <div class="mt-1">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" id="username" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Usuario" value="${el.username}" />
            </div>
        ...
        <div class="mt-1">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" id="email" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Email" value="${el.email}">
            </div>
        ...
        <div class="col-span-1 md:col-span-2 lg:col-span-3">
            <button class="p-2 bg-sky-900 hover:bg-sky-700 rounded-md text-white" id="save-edit-user">Guardar</button>
        </div>
    </div>`;
