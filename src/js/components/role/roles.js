...
const roles = () => {
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gab-4">
        <div class="text-2xl font-bold text-sky-900">Lista de roles <i class="bi bi-person-lines-fill"></i></div>
        <div class="text-2xl md:mb-0 mb-4">${breadcrumb('roles')}</div>
    </div>
    ${buttonSearchInput('add-role', '+ Nuevo rol')}
            ...
            <table class="border border-collapse table-auto w-full" id="tbl-order">
                <thead>
                    <tr>
                        ...
                        <th class="bg-sky-700 border text-white tbl-profile-size-name pl-5 col-index" data-col-index="1" style="text-align:left;">Rol</th>
